    ...
    <footer className="mt-auto w-full text-center py-6 text-sm text-gray-400 font-semibold border-t border-gray-200 bg-gray-50">
      ...
      <div className="flex justify-center gap-4">
        <a
          ...
          className="flex items-center gap-1 text-sky-500 hover:text-sky-600 transition-colors duration-150"
        >
          <svg
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-1 text-gray-600 hover:text-gray-800 transition-colors duration-150"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="w-4 h-4"
