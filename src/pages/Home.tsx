...
export default function Home() {
  ...
  const { dataTadarus, loading } = useTadarus();
        ...
        {loading ? (
          ...
          dataTadarus.map((tadarus) => (
            <div
              ...
              className="cursor-pointer font-semibold text-gray-500 border-gray-300 border-2 rounded-2xl bg-white shadow-[0_1px_0_0_rgba(0,0,0,0.1)] p-4 transition-all duration-150 mt-4 hover:bg-gray-100 hover:-translate-y-1 hover:shadow-[0_4px_0_0_rgba(0,0,0,0.1)] text-left"
            >
